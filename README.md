...
## 3. 시스템 아키텍처
<img width="1900" height="1127" alt="Web App Reference Architecture (4) (1)" src="https://github.com/user-attachments/assets/c5f98228-7273-42a2-87dc-b5b58cdd3472" />
...
| 리뷰<br>다국어 | 기사님 마이페이지,<br>기사님 찾기,<br>AWS | 견적 (고객), <br>찜한 기사님 | 견적 (기사),<br>스키마 | 견적요청서(고객) | 인증 및 유저<br>AWS | 알림<br>랜딩페이지 |
